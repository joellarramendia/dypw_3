...
<div class="container">
    ...
    <nav class="navbar navbar-light bg-light">
        <div class="container-fluid">
            <a href="{{ url('clientes/formulario') }}" class="btn btn-primary mr-auto">Nuevo</a>
            <form class="d-flex ml-auto" action="{{route('buscar')}}" method="GET">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('eliminar', ['id' => $cliente->id]) }}" onclick="return confirm('¿Estás seguro de que deseas eliminar este usuario?');" class="btn btn-danger">
                        Eliminar
                    </a>
